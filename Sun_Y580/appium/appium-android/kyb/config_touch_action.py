...
desirde_caps['app'] = r'D:\appium_sw\4\App\mymoney.apk'
desirde_caps['appPackage'] = 'com.mymoney'
desirde_caps['appActivity'] = 'com.mymoney.biz.splash.SplashScreenActivity'
